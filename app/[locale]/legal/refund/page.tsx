    ...
    <>
      ...
      <div className="mt-6 space-y-6 text-sm text-[var(--foreground)] leading-relaxed">
        <section className="rounded-2xl border border-[var(--border)] bg-[var(--card)] p-5">
          <h2 className="text-lg font-bold text-[var(--primary)] mb-3">1. Отмена заказа до начала исполнения</h2>
          <p className="mb-2">
        ...
        <section className="rounded-2xl border border-[var(--border)] bg-[var(--card)] p-5">
          <h2 className="text-lg font-bold text-[var(--primary)] mb-3">2. Возврат денежных средств</h2>
        ...
        <section className="rounded-2xl border border-[var(--border)] bg-[var(--card)] p-5">
          <h2 className="text-lg font-bold text-[var(--primary)] mb-3">3. Отмена заказа в процессе исполнения</h2>
          <p className="mb-2">
        ...
        <section className="rounded-2xl border border-[var(--border)] bg-[var(--card)] p-5">
          <h2 className="text-lg font-bold text-[var(--primary)] mb-3">4. Возврат при некачественном исполнении</h2>
          <p className="mb-2">
        ...
        <section className="rounded-2xl border border-[var(--border)] bg-[var(--card)] p-5">
          <h2 className="text-lg font-bold text-[var(--primary)] mb-3">5. Случаи, когда возврат не производится</h2>
        ...
        <section className="rounded-2xl border border-[var(--border)] bg-[var(--card)] p-5">
          <h2 className="text-lg font-bold text-[var(--primary)] mb-3">6. Порядок предъявления претензий</h2>
          <p className="mb-2">
