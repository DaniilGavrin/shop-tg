  ...
  return (
    <>
      ...
      <div className="mt-6 space-y-6 text-sm text-[var(--foreground)] leading-relaxed">
        ...
        <section className="rounded-2xl border border-[var(--border)] bg-[var(--card)] p-5">
          <h2 className="text-lg font-bold text-[var(--primary)] mb-3">2. Персональные данные, собираемые сайтом</h2>
        ...
        <section className="rounded-2xl border border-[var(--border)] bg-[var(--card)] p-5">
          <h2 className="text-lg font-bold text-[var(--primary)] mb-3">3. Цели обработки персональных данных</h2>
        ...
        <section className="rounded-2xl border border-[var(--border)] bg-[var(--card)] p-5">
          <h2 className="text-lg font-bold text-[var(--primary)] mb-3">4. Способы и сроки обработки персональных данных</h2>
          <p className="mb-2">
        ...
        <section className="rounded-2xl border border-[var(--border)] bg-[var(--card)] p-5">
          <h2 className="text-lg font-bold text-[var(--primary)] mb-3">5. Передача персональных данных третьим лицам</h2>
          <p className="mb-2">
        ...
        <section className="rounded-2xl border border-[var(--border)] bg-[var(--card)] p-5">
          <h2 className="text-lg font-bold text-[var(--primary)] mb-3">6. Права Пользователя</h2>
          ...
          <p className="mt-3">
            ...
            <a href="mailto:daniilgavrin@bytewizard.ru" className="text-[var(--primary)] hover:text-[var(--primary)] ml-1">
        ...
        <section className="rounded-2xl border border-[var(--border)] bg-[var(--card)] p-5">
          <h2 className="text-lg font-bold text-[var(--primary)] mb-3">7. Защита персональных данных</h2>
          <p>
        ...
        <section className="rounded-2xl border border-[var(--border)] bg-[var(--card)] p-5">
          <h2 className="text-lg font-bold text-[var(--primary)] mb-3">8. Изменение Политики конфиденциальности</h2>
          <p>
